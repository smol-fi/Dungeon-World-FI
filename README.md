# Dungeon World (DW) resursseja ja tietoa LAN-pelaajille
...
> Monella vastustajalla ja hahmolla on ainutlaatuinen tyyli ja tapa. Pidä mielessä miten voit parhaiten hyödyntää hahmosi ominaisuuksia. Fighterilla voi esimerkiksi olla ase, jolla on +1 vahinkoa (Serrated edges), sekä sotkuisa ja erityisen voimakas (suuri) ase. Kannattaa olla luova, kun kuvailee hyökkäystään! Pelikirjan 18:ssa luvussa (Equipment) kerrotaan tarkemmin varustuksien eri luonteiden merkityksistä.
